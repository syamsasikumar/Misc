...
hi StatusLine   term=bold cterm=bold ctermfg=DarkBlue ctermbg=White
hi StatusLine   gui=bold guifg=DarkBlue guibg=White

hi StatusLineNC term=NONE cterm=NONE ctermfg=DarkBlue ctermbg=White
hi StatusLineNC gui=NONE guifg=DarkBlue guibg=White

hi Visual       term=NONE cterm=NONE ctermfg=DarkBlue ctermbg=DarkCyan
hi Visual       gui=NONE guifg=DarkBlue guibg=DarkCyan

hi Search       term=NONE cterm=NONE ctermbg=Gray
hi Search       gui=NONE guibg=Gray

hi VertSplit    term=NONE cterm=NONE ctermfg=DarkBlue ctermbg=White
hi VertSplit    gui=NONE guifg=DarkBlue guibg=White
...
hi Cursor       ctermfg=DarkBlue ctermbg=Yellow
hi Cursor       guifg=DarkBlue guibg=Yellow
